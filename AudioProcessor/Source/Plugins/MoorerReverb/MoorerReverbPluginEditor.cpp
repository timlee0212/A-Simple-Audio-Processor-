...
#include "MoorerReverbPluginEditor.h"
    ...
    : AudioProcessorEditor(ownerFilter)
{
    addAndMakeVisible (DecayLabel = new Label ("Decay Label",
                                               TRANS("Decay")));
    DecayLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
    ...
    addAndMakeVisible (LowPassLabel = new Label ("LowPass Label",
                                                 TRANS("Low Pass")));
    LowPassLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
    ...
    PercentLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
    ...
    KHzLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
    ...
    SecLabel2->setFont (Font (Font::getDefaultMonospacedFontName(), 12.00f, Font::bold));
