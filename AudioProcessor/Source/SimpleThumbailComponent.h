...
private:
	...
	void timerCallback() override
	{
		if (canMoveTransport())
			...
			setRange(visibleRange.movedToStartAt(transSource.getCurrentPosition() - (visibleRange.getLength() / 2.0)));
	}
	...
	void updateCursorPosition()
	{
		...
		currentPositionMarker.setRectangle(Rectangle<float>(timeToX(transSource.getCurrentPosition()) - 0.75f, 0,
